...
const Contact: React.FC = () => {
  ...
  return (
    <section id="contact" className="py-16 md:py-24 px-6 bg-bg-base">
          ...
          <div className="flex flex-col lg:flex-row">
            ...
            <div className="lg:w-1/2 p-6 md:p-10">
              <form className="space-y-5" onSubmit={handleSubmit}>
                ...
                <button type="submit" className="w-full bg-accent hover:bg-accent-muted text-white font-medium py-4 rounded-lg text-sm transition-colors duration-300">
                  Send Message
                </button>
              </form>
            </div>
              ...
              <div className="space-y-5">
                ...
                <div>
                  ...
                  <div className="flex gap-3">
                    <a href="mailto:ewies.pm@gmail.com" className="size-11 rounded-xl bg-bg-surface border border-border-subtle flex items-center justify-center text-text-secondary hover:bg-accent hover:border-accent hover:text-white transition-all duration-300" title="Email">
                      <span className="material-symbols-outlined text-lg">mail</span>
                    </a>
                    <a href="tel:+966506871951" className="size-11 rounded-xl bg-bg-surface border border-border-subtle flex items-center justify-center text-text-secondary hover:bg-accent hover:border-accent hover:text-white transition-all duration-300" title="Call">
                      <span className="material-symbols-outlined text-lg">call</span>
                    </a>
                    <a href="https://wa.me/966506871951" target="_blank" rel="noopener noreferrer" className="size-11 rounded-xl bg-bg-surface border border-border-subtle flex items-center justify-center text-text-secondary hover:bg-[#25D366] hover:border-[#25D366] hover:text-white transition-all duration-300" title="WhatsApp">
                    ...
                    <a href="https://www.linkedin.com/in/omar-ewies-product-manager/" target="_blank" rel="noopener noreferrer" className="size-11 rounded-xl bg-bg-surface border border-border-subtle flex items-center justify-center text-text-secondary hover:bg-[#0A66C2] hover:border-[#0A66C2] hover:text-white transition-all duration-300" title="LinkedIn">
                    ...
                    <a href="https://github.com/oebitw" target="_blank" rel="noopener noreferrer" className="size-11 rounded-xl bg-bg-surface border border-border-subtle flex items-center justify-center text-text-secondary hover:bg-text-muted hover:border-text-muted hover:text-white transition-all duration-300" title="GitHub">
